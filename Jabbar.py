...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mJabbarrbugti\033[1;91m...............
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Jabbar_BuGtiTool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Jabbar_BuGti_HacKerWhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 03113383949✓')
	    psb('WellCome To B4_BALOCH')
	    psb('Congratulations JABBAR_BUGTi Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Jabbar BuGti✓')
	    psb('🔓Password ☆ 786786✓')
